...
class Gesture() :
    ...
    def DrawLine(self, img, finger7_x, finger7_y, finger8_x, finger8_y):
        ...
        if finger7_x < finger8_x :
            end = (self.window_x , self.window_x*a + b)
    ...
    def Whatgesture(self,image, hand_landmarks):
        ...
        if point_out_something :        
            ...
            # 여기 DrawLine이 아닌
            # Text 인식 위한 contour 인식으로 바꾸기 
            self.DrawLine(image,finger7_x,finger7_y,finger8_x,finger8_y)